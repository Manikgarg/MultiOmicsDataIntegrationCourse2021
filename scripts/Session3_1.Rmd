...
Where N<sub>c</sub> is the total number of clinical annotations associated with atleast one factor, N<sub>f</sub> is the total number of factors accosiated with at least one clinical annotation, and L is the total number of associations between clinical annotations and factors.
